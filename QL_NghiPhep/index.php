...
?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Quản Lý Nghỉ Phép</h1>
                  <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3"style="height: 50px">
                            <h6 class="m-0 font-weight-bold text-dark">Bảng Nhân Viên Xin Nghỉ Phép</h6>
                            <form
                        class="d-none d-sm-inline-block form-inline mr-auto ml-md- my-2 my-md-0">
                        <div class="input-group rr">
                            <input type="text" class="form-control border-0 small" placeholder="Tìm Kiếm Trong Bảng Nghỉ Phép..."
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="6" style="border: none;"><a href="" data-toggle="modal" data-target="#logoutModal1"><input type="submit" value="Thêm" class="text-white bg-dark border-0" style="height: 40px; width: 100px; border-radius: 120px;" ></a>
                                        <a href="https://img.timviec.com.vn/2020/07/mau-don-xin-nghi-phep-1.png" class="tt" target = "blank">Mẫu Đơn Xin Nghỉ</a>
                                        </td>
...
while ($rows2 = mysqli_fetch_array($row_liet_ke2)) {
    ...
    <tbody>
        <tr>
            ...
            <td><?php echo $rows2['loainghiphep'] ?></td>
            <td><?php echo $rows2['don'] ?></td>
            <td><?php echo $rows2['songaynghi'] ?></td>
            <td>
...
<?php } ?>
    ...
    <div class="modal fade" id="logoutModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
            <h5 class="modal-title text-dark" id="exampleModalLabel" style="padding: 20px"><strong>Thêm Nghỉ Phép</h5>
                <div class="modal-header">
                    ...
                    <p>Loại Nghỉ Phép: </p><input type="text" name="loainghiphep">
                                            <p>Đơn Xin Nghỉ: </p><input type="url" name = "don">
                                            <p>Số Ngày Nghỉ: </p><input type="number" name = "songaynghi">
                    </div></strong>
    ...
    <div class="modal fade" id="logoutModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
            <h5 class="modal-title text-dark" id="exampleModalLabel" style="padding: 20px"><strong>Sửa Nghỉ Phép</h5>
                <div class="modal-header">
                    <div class="text-centers text-dark">
                    <p>Tên Nhân Viên</p><input type="number">
                    <p>Phòng Ban</p><input type="number">
                    <p>Loại Nghỉ Phép: </p><input type="text">
                                            <p>Đơn Xin Nghỉ: </p><input type="url">
                    </div></strong>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-secondary" type="button" data-dismiss="modal">Huỷ</button>
