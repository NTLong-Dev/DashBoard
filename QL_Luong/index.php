...
if ($username['Phanquyen'] == 1){
    $sql_lietke2 = "SELECT * FROM quanlyluong";
    $row_liet_ke2 = mysqli_query($mysqli,$sql_lietke2);

}else{
    $sql_lietke2 = "SELECT * FROM quanlyluong WHERE tk = '".$username['TenDangNhap']."' ";
    $row_liet_ke2 = mysqli_query($mysqli,$sql_lietke2);
}
?>
<!DOCTYPE html>
...
?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Quản Lý Lương</h1>
                  <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3"style="height: 50px">
                            <h6 class="m-0 font-weight-bold text-dark">Bảng Lương</h6>
                            <form
                        class="d-none d-sm-inline-block form-inline mr-auto ml-md- my-2 my-md-0">
                        <div class="input-group rr">
                            <input type="text" class="form-control border-0 small" placeholder="Tìm Kiếm Trong Bảng Lương..."
                        ...
                        while($rows2 = mysqli_fetch_array($row_liet_ke2)){
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><?php echo $rows2['Luong_coban'] ?></td>
                                    <td><?php echo $rows2['Luong_phucap'] ?></td>
                                    <td><?php echo $rows2['Thuong'] ?></td>
                                    <td><?php echo $rows2['Luong_khautru'] ?></td>
                                    <td><?php 
                                    $tong = $rows2['Luong_coban'] + $rows2['Luong_phucap'] + $rows2['Thuong'] - $rows2['Luong_khautru'] ;
                                    echo $tong;
                                    ?></td>
                                    <?php 
                                    $username = $_SESSION['user_info'];
    ...
    <div class="modal fade" id="logoutModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
            <h5 class="modal-title text-dark" id="exampleModalLabel" style="padding: 20px"><strong>Thêm Lương Của Nhân Viên</h5>
                <div class="modal-header">
                    ...
                    <p>Lương Cơ Bản</p><input type="number" name = "luongcb">
                    <p>Lương Khấu Trừ</p><input type="number" name = "luongkt">
                    <p>Lương Phụ Cấp</p><input type="number" name = "luongpc">
                    <p>Thưởng</p><input type="number" name = "thuong">
                    <p>Tài Khoản</p>
                    <select name="tdn">
                                                <?php
                                                mysqli_data_seek($row_liet_ke, 0); 
    ...
    <div class="modal fade" id="logoutModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
            <h5 class="modal-title text-dark" id="exampleModalLabel" style="padding: 20px"><strong>Sửa Lương Nhân Viên</h5>
                <div class="modal-header">
                    <div class="text-centers text-dark">
                    <p>Tên Nhân Viên</p><input type="number">
                    <p>Phòng Ban</p><input type="number">
                    <p>Lương Cơ Bản</p><input type="number">
                    <p>Lương Khấu Trừ</p><input type="number">
                    <p>Lương Phụ Cấp</p><input type="number">
                    <p>Thưởng</p><input type="number">
                    <p>Tài Khoản</p>
                    <select name="tdn">
                                                <?php
                                                mysqli_data_seek($row_liet_ke, 0); 
